...
| Phase                                                  | File                                                             | Status  |
| ------------------------------------------------------ | ---------------------------------------------------------------- | ------- |
| Phase 11 — Discovery (`kat list`, ID prefixes, `show`) | [implementation-plan-phase11.md](implementation-plan-phase11.md) | planned |
| Phase 12 — Output Modes (compact/full rendering)       | [implementation-plan-phase12.md](implementation-plan-phase12.md) | planned |
| Phase 13 — Multi-Operation Change Design               | [implementation-plan-phase13.md](implementation-plan-phase13.md) | planned |
