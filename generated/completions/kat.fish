...
complete -c kat -n "__fish_kat_needs_command" -f -a "context" -d 'Porcelain: Retrieve point-to-point context surrounding root elements'
complete -c kat -n "__fish_kat_needs_command" -f -a "author" -d 'Porcelain: Declaratively compile and stage a JSON batch of authoring claims'
complete -c kat -n "__fish_kat_needs_command" -f -a "check" -d 'Porcelain: Perform comprehensive mechanical consistency check and advisory graph quality analysis'
complete -c kat -n "__fish_kat_needs_command" -f -a "commit" -d 'Porcelain: Commit all staged operations in open transaction and publish'
complete -c kat -n "__fish_kat_needs_command" -f -a "abort" -d 'Porcelain: Abort open transaction and discard all staged operations'
...
complete -c kat -n "__fish_kat_using_subcommand context" -s h -l help -d 'Print help'
complete -c kat -n "__fish_kat_using_subcommand author" -s e -l example -d 'Print a working JSON authoring claim template example'
...
complete -c kat -n "__fish_kat_using_subcommand check" -s h -l help -d 'Print help'
complete -c kat -n "__fish_kat_using_subcommand commit" -l json -d 'Output structured machine JSON envelope'
complete -c kat -n "__fish_kat_using_subcommand commit" -s h -l help -d 'Print help'
complete -c kat -n "__fish_kat_using_subcommand abort" -l json -d 'Output structured machine JSON envelope'
complete -c kat -n "__fish_kat_using_subcommand abort" -s h -l help -d 'Print help'
...
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "init" -d 'Initialize a new KAT repository in the current directory'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "status" -d 'Display a concise summary of current accepted repository status and health'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "context" -d 'Porcelain: Retrieve point-to-point context surrounding root elements'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "author" -d 'Porcelain: Declaratively compile and stage a JSON batch of authoring claims'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "check" -d 'Porcelain: Perform comprehensive mechanical consistency check and advisory graph quality analysis'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "commit" -d 'Porcelain: Commit all staged operations in open transaction and publish'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "abort" -d 'Porcelain: Abort open transaction and discard all staged operations'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "list" -d 'List knowledge elements in the current accepted state'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "create" -d 'Create a new knowledge element'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "update" -d 'Update title or description of an existing active knowledge element'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "deprecate" -d 'Mark an active knowledge element as Deprecated'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "supersede" -d 'Supersede an existing knowledge element with a new replacement element'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "link" -d 'Establish a semantic relationship between two elements'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "unlink" -d 'Remove a relationship from the current accepted state'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "account" -d 'Re-baseline an artifact\'s accountability relationships against current knowledge versions'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "show" -d 'Show detailed view of a resolved active knowledge element'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "history" -d 'Reconstruct and display the accepted change revision graph'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "trace" -d 'Trace a knowledge element back to its origin'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "impact" -d 'Analyze potential impact and consequences of changing an element'
...
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status context author check commit abort list create update deprecate supersede link unlink account show history trace impact validate artifacts change ontology help" -f -a "change" -d 'Manage multi-operation change transactions'
