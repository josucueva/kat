...
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "init" -d 'Initialize a new KAT repository in the current directory'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "status" -d 'Display a concise summary of current accepted repository status and health'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "list" -d 'List knowledge elements in the current accepted state'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "create" -d 'Create a new knowledge element'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "update" -d 'Update title or description of an existing active knowledge element'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "deprecate" -d 'Mark an active knowledge element as Deprecated'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "supersede" -d 'Supersede an existing knowledge element with a new replacement element'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "link" -d 'Establish a semantic relationship between two elements'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "unlink" -d 'Remove a relationship from the current accepted state'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "show" -d 'Show detailed view of a resolved active knowledge element'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "history" -d 'Reconstruct and display the accepted change revision graph'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "trace" -d 'Trace a knowledge element back to its origin'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "impact" -d 'Analyze potential impact and consequences of changing an element'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "validate" -d 'Run mechanical consistency validation across the current accepted state'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "artifacts" -d 'Evaluate artifact accountability baselines against accepted state'
complete -c kat -n "__fish_kat_using_subcommand help; and not __fish_seen_subcommand_from init status list create update deprecate supersede link unlink show history trace impact validate artifacts help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
