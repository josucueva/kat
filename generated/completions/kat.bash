_kat() {
    ...
    do
        case "${cmd},${i}" in
            ...
            kat,artifacts)
                ...
                ;;
            kat,author)
                cmd="kat__subcmd__author"
                ;;
            kat,change)
                cmd="kat__subcmd__change"
                ;;
            kat,check)
                cmd="kat__subcmd__check"
                ;;
            kat,commit)
            ...
            kat,help)
                ...
                ;;
            kat,history)
                cmd="kat__subcmd__history"
                ;;
            kat,impact)
                cmd="kat__subcmd__impact"
                ;;
            kat,init)
                cmd="kat__subcmd__init"
                ;;
            kat,link)
                cmd="kat__subcmd__link"
                ;;
            kat,list)
            ...
            kat,trace)
                ...
                ;;
            kat,unlink)
                cmd="kat__subcmd__unlink"
                ;;
            kat,update)
                cmd="kat__subcmd__update"
                ;;
            kat,validate)
            ...
            kat__subcmd__change__subcmd__help,status)
                ...
                ;;
            kat__subcmd__help,abort)
                cmd="kat__subcmd__help__subcmd__abort"
                ;;
            ...
            kat__subcmd__help,artifacts)
                ...
                ;;
            kat__subcmd__help,author)
                cmd="kat__subcmd__help__subcmd__author"
                ;;
            kat__subcmd__help,change)
                cmd="kat__subcmd__help__subcmd__change"
                ;;
            kat__subcmd__help,check)
                cmd="kat__subcmd__help__subcmd__check"
                ;;
            ...
            kat__subcmd__help,help)
                ...
                ;;
            kat__subcmd__help,history)
                cmd="kat__subcmd__help__subcmd__history"
                ;;
            kat__subcmd__help,impact)
                cmd="kat__subcmd__help__subcmd__impact"
                ;;
            kat__subcmd__help,init)
                cmd="kat__subcmd__help__subcmd__init"
                ;;
            kat__subcmd__help,link)
                cmd="kat__subcmd__help__subcmd__link"
                ;;
            ...
            kat__subcmd__help,trace)
                ...
                ;;
            kat__subcmd__help,unlink)
                cmd="kat__subcmd__help__subcmd__unlink"
                ;;
            kat__subcmd__help,update)
                cmd="kat__subcmd__help__subcmd__update"
                ;;
            ...
            kat__subcmd__ontology,help)
                ...
                ;;
            kat__subcmd__ontology,show)
                cmd="kat__subcmd__ontology__subcmd__show"
                ;;
            kat__subcmd__ontology__subcmd__help,help)
                cmd="kat__subcmd__ontology__subcmd__help__subcmd__help"
                ;;
    ...
    case "${cmd}" in
        ...
        kat__subcmd__artifacts)
            opts="-h --stale --compact --json --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        kat__subcmd__help)
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__abort)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        kat__subcmd__help__subcmd__artifacts)
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__author)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        kat__subcmd__help__subcmd__change__subcmd__status)
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__check)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__commit)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        kat__subcmd__help__subcmd__context)
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__create)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        kat__subcmd__help__subcmd__deprecate)
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__history)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__impact)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__init)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__link)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__list)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        kat__subcmd__help__subcmd__supersede)
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__trace)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__unlink)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__update)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__help__subcmd__validate)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__history)
            opts="-h --oneline --limit --element --compact --json --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        kat__subcmd__impact)
            opts="-h --max-depth --compact --json --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        kat__subcmd__link)
            ...
            ;;
        kat__subcmd__list)
            opts="-h --type --lifecycle --json --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        kat__subcmd__ontology)
            ...
            return 0
            ;;
        kat__subcmd__ontology__subcmd__help)
            opts="show help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__ontology__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__ontology__subcmd__help__subcmd__show)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        kat__subcmd__ontology__subcmd__show)
            opts="-h --compact --json --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        kat__subcmd__supersede)
            ...
            ;;
        kat__subcmd__trace)
            opts="-h --paths --max-depth --compact --json --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        kat__subcmd__update)
            ...
            return 0
            ;;
        kat__subcmd__validate)
            opts="-h --coverage --compact --json --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
...
if [[ "${BASH_VERSINFO[0]}" -eq 4 && "${BASH_VERSINFO[1]}" -ge 4 || "${BASH_VERSINFO[0]}" -gt 4 ]]; then
    complete -F _kat -o nosort -o bashdefault -o default kat
else
    complete -F _kat -o bashdefault -o default kat
fi
