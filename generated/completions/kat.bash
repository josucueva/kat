_kat() {
    ...
    case "${cmd}" in
        ...
        kat__subcmd__history)
            opts="-h --oneline --limit --element --compact --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        kat__subcmd__supersede)
            ...
            ;;
        kat__subcmd__trace)
            opts="-h --paths --max-depth --compact --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
